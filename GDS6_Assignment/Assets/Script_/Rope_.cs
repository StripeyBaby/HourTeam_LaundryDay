...
public class Rope_ : MonoBehaviour
{
    ...
    private void ApplyConstraint()
    {
        ...
        firstSegment.posNow = this.character1.position;
        this.ropeSegments[0] = firstSegment;

        RopeSegment endSegment = this.ropeSegments[this.segmentLength - 1];
        endSegment.posNow = this.character2.position;
    ...
    private void DrawRope()
    {
        ...
        for (int i = 0; i < this.segmentLength; i++)
        {
            ...
            colliderPos.Add(ropePositions[i]);
        }
        ...
        collider.SetPoints(colliderPos);
    }
  ...
  //     lineRenderer.GetPosition(positions);
  //     return positions;
  // }
  //
